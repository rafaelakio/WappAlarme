...
public abstract class Hilt_ScheduledMessageFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ScheduledMessageFragment() {
    super();
  }

  Hilt_ScheduledMessageFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ScheduledMessageFragment_GeneratedInjector) this.generatedComponent()).injectScheduledMessageFragment(UnsafeCasts.<ScheduledMessageFragment>unsafeCast(this));
    }
  }
