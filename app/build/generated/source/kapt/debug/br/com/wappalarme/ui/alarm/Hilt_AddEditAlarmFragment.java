...
public abstract class Hilt_AddEditAlarmFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AddEditAlarmFragment() {
    super();
  }

  Hilt_AddEditAlarmFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AddEditAlarmFragment_GeneratedInjector) this.generatedComponent()).injectAddEditAlarmFragment(UnsafeCasts.<AddEditAlarmFragment>unsafeCast(this));
    }
  }
