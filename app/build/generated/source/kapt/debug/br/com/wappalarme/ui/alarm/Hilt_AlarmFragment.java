...
public abstract class Hilt_AlarmFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AlarmFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AlarmFragment_GeneratedInjector) this.generatedComponent()).injectAlarmFragment(UnsafeCasts.<AlarmFragment>unsafeCast(this));
    }
  }
