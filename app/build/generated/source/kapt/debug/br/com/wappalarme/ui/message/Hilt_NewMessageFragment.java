...
public abstract class Hilt_NewMessageFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_NewMessageFragment() {
    super();
  }

  Hilt_NewMessageFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((NewMessageFragment_GeneratedInjector) this.generatedComponent()).injectNewMessageFragment(UnsafeCasts.<NewMessageFragment>unsafeCast(this));
    }
  }
